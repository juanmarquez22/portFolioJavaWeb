 ...
 * @author juanm
 */
@WebServlet(name = "SvPregrado", urlPatterns = {"/SvPregrado"})
public class SvPregrado extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        Estudio grado = new Pregrado(promedio, 0, titulo, institucion, imagen, ingreso, egreso);
